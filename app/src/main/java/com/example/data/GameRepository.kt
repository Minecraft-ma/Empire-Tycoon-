...
object GameRepository {
    ...
    fun getDefaultSponsorshipContracts(): List<SponsorshipContract> = listOf(
        SponsorshipContract(
            ...
            requiredNetWorth = 400.0,
            signingBonus = 75.0,
            passiveIncomeMultiplier = 0.10, // +10%
            directPayoutPerSec = 0.50
        ),
        SponsorshipContract(
            ...
            requiredNetWorth = 3_500.0,
            signingBonus = 350.0,
            passiveIncomeMultiplier = 0.15, // +15%
            directPayoutPerSec = 2.0
        ),
        SponsorshipContract(
            ...
            requiredNetWorth = 25_000.0,
            signingBonus = 2_500.0,
            passiveIncomeMultiplier = 0.25, // +25%
            directPayoutPerSec = 15.0
        ),
        SponsorshipContract(
    ...
    fun getDefaultLuxuryAssets(): List<LuxuryAsset> = listOf(
        ...
        LuxuryAsset(
            ...
            isPurchased = false,
            prestigeScore = 900,
            rentRevenuePerSec = 2_200.0,
            passiveIncomeMultiplier = 0.18,
            clickPowerBoostPercent = 0.18,
            iconEmoji = "🏖️",
